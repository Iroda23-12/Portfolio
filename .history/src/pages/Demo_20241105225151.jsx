...
const Banner = () => (
    <div className="container2">
        <center><img src="logodemo.png" alt="Banner" /></center>
...
<div class="bot-address">
    <div class="bot-address-title">We are located at:  </div><div class="bot-address-body"></div>
Chilonzor district of Tashkent city</div>
<div class="bot55">
    <p>Join us in social networks</p>
    <a href="https://t.me/m_i_jewellry"> <i class="fa-brands fa-telegram" style="color: #74C0FC;"></i></a>
   <a href="https://www.instagram.com/m_i_jewelry?igsh=MXh6MHZ2YW45amRobw=="> <i class="fa-brands fa-instagram" style="color: #ff006f;"></i></a>
</div>
);
