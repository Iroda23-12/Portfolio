    ...
    <div>
      <header>
        ...
        <div className="end-menu__container">
          <p className="category__label">MAKEUP</p>
        </div>
        ...
        <div className="image-gallery__container">
          <div className="image-gallery__item">
            <img
              src="photo_2024-05-31_11-52-59.jpg"
              alt="Image 1"
              width="350px"
              height="300px"
            />
            <img
              src="photo_2024-05-31_11-22-34.jpg"
              alt="Image 2"
              width="300px"
              height="450px"
            />
            <img
              src="photo_2024-05-31_11-26-06.jpg"
              alt="Image 3"
              width="350px"
              height="390px"
            />
