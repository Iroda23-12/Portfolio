...
const Allproject = () => {
    return (
        <>
        <h1 style={{textAlign:'center',backgroundColor:'-moz-initial'}}>Dior</h1>
            <div>
            ...
            <h1 style={{textAlign:'center',backgroundColor:'skyblue'}}>Demo day1</h1>
            ...
            <h1 style={{textAlign:'center',backgroundColor:'skyblue'}}>2Rism</h1>
