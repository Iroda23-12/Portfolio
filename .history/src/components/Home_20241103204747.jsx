  ...
  return (
    <>
      <div className="home" style={{
        // backgroundImage:'url(https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRJLcXuo0Arfw9-U-uD_kJH3tal30ztiMniBrFXFUMwg18SCL9O)',
      ...
      <div className="skills" id="skills">
        ...
        <div
          ...
          style={{
            display: 'grid',
            gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', // Автоматическое выравнивание колонок
            gap: '20px',
            justifyItems: 'center', // Центрирование иконок
            alignItems: 'center',
          }}
        >
          <div className="icon-skill">
            ...
            />
            <h2>ReactJs</h2>
            <button className="view-code-button">Посмотреть код</button>
          </div>
          <div className="icon-skill">
          ...
          <div className="icon-skill">
            <img
              src="https://img.icons8.com/external-tal-revivo-shadow-tal-revivo/48/000000/external-netlify-a-cloud-computing-company-that-offers-hosting-and-serverless-backend-services-for-static-websites-logo-shadow-tal-revivo.png"
              alt="Netlify"
            />
            <h2>Netlify</h2>
            <button className="view-code-button">Посмотреть код</button>
