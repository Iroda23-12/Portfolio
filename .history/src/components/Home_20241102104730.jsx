  ...
  return (
    <>
      ...
      <div className="skills" >
        ...
        <h2><FontAwesomeIcon icon={faJs} color='yellow' />JavaScript</h2>
        <h2> <img src="https://img.icons8.com/color/48/000000/bootstrap.png" width={'21px'}  alt="" /> Bootstrap</h2>
        <h2><img src="https://img.icons8.com/color/48/000000/css3.png" alt="" /> color='#F56200' />Html</h2>
        <h2><FontAwesomeIcon icon={faCss3} color='#0397E1' />Css</h2>
      </div>
    </>
  );
};
