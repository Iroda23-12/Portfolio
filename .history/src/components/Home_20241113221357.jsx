...
import { faGithub, faInstagram, faNodeJs, faTelegram, faTwitter, } from '@fortawesome/free-brands-svg-icons';
    ...
    <>
      <header>
        <a href="/" className="logo">
          <i className="fab fa-node-js"><FontAwesomeIcon icon={faNodeJs}/></i>
          <img src="logo.png" style={{ width: '70px', marginTop: '10px' }} alt="Logo" />
        </a>

        {/* Checkbox для управления меню */}
        <input type="checkbox" id="menu-toggle" />
        <label htmlFor="menu-toggle" id="menu" className="fas fa-bars"></label>
