...
const Home = () => {
  ...
  return (
    <>
      <header class="navbar_gl">
        <a href="/" class="logo"><img src="logo.png" style="width: 70px; margin-top: 10px;" alt="" /></a>
        <nav class="navbar">
          <label for="nav" class="menu-toggle"><i class="fa fa-bars"></i></label>
          <input type="checkbox" id="nav" />
          <ul>
            <li class="close-btn" onclick="document.getElementById('nav').checked = false"><i class="fa fa-times"></i></li>
            <li><a href="#home">Главная</a></li>
            <li><a href="#about">О компании</a></li>
            <li><a href="#skills">Навыки</a></li>
            <li><a href="#project">Проекты</a></li>
            <li><a href="#contact">Контакты</a></li>
            <select class="language-selector" onchange="handleSelectChange(event)">
      ...
      <div className="container mx-auto flex flex-wrap justify-between space-y-6 md:space-y-0">
        ...
        <div className="w-full md:w-1/3">
          ...
          <ul className="space-y-4">
            ...
            <li><FontAwesomeIcon icon={faMapMarkedAlt}color='orange' />{t(" Uzbekistan Tashkent")}</li><br />
          </ul>
