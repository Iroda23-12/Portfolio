    ...
    <>
      <header >
        ...
        <nav className="navbar">
          ...
          <h1 className='text-2xl font-bold mb-4 text-gray-100 dark:text-gray-900'>Dark mode Example</h1>
          <button onClick={() =>{ 
          setDarkMode(!darkMode)}} className='px-4 py-2 rounded bg-blue-500 text-white dark:bg-blue-700 transition-colors duration-500'> Toggle dark Mode</button>
        </div>
          </ul>
        </nav>
      </header>
