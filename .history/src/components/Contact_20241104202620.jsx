import { faCommentDots, faEnvelope, faHeadset, faPhone, faUser } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div className="content">
                        ...
                        <form id="contact-form">
                            ...
                            <div className="button-area">
                                <button type="submit">
                                    Submit <i className="fa fa-paper-plane"><FontAwesomeIcon icon={fapaperp}/></i>
                                </button>
                            </div>
                        </form>
                    </div>
