  ...
  return (
    <>
      ...
      <div className="about" style={{
        ...
        backgroundImage: 'https://img.freepik.com/free-photo/light-gray-abstract-background_53876-101909.jpg?semt=ais_hybrid, no-repeat',
        backgroundSize: 'cover',
        position: 'relative'
      }}>

        <h1 style={{fontFamily:'sans-serif'}}> <FontAwesomeIcon icon={faUser} />  About Me</h1><br />
