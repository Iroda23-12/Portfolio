...
import { faArrowAltCircleDown, faBars, faBurger, faCommentDots, faEnvelope, faHamburger, faHeadset, faLaptopCode, faMapMarkedAlt, faPaperPlane, faPhone, faPhoneAlt, faUser, } from '@fortawesome/free-solid-svg-icons';
