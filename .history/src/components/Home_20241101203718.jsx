...
import { faBootstrap, faGithub, faInstagram, faJava, faJs, faReact, faTelegram } from '@fortawesome/free-brands-svg-icons';
  ...
  return (
    <>
      ...
      <div className="skills">
        ...
        <h2><FontAwesomeIcon icon={faht} color='yellow' />ReactJs</h2>
      </div>
    </>
  );
};
