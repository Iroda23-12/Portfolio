...
const Home = () => {
  return (
    <>
      <div className="home" style={{ backgroundColor: '#F7F7F7', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
        <div className="intro" style={{ fontSize: '25px', textAlign: 'center' }}>
