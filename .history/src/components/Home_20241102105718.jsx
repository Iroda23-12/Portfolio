    ...
    <>
      ...
      {/* <div className="skills" >
        ...
        <div className="skills1">
          ...
          <h2><img src="https://img.icons8.com/external-tal-revivo-color-tal-revivo/48/000000/external-react-a-javascript-library-for-building-user-interfaces-logo-color-tal-revivo.png" alt="" />ReactJs</h2>
          </div>
          <div className="icon-skill">
          <h2><img src="https://img.icons8.com/color/48/000000/javascript--v1.png" alt="" />JavaScript</h2>
          </div>
          <div className="icon-skill">
          <h2> <img src="https://img.icons8.com/color/48/000000/bootstrap.png" alt="" /> Bootstrap</h2>
          </div>
          <div className="icon-skill">
          <h2><img src="https://img.icons8.com/color/48/000000/html-5--v1.png" alt="" />Html</h2>
          </div>
          <div className="icon-skill">
            <h2><img src="https://img.icons8.com/color/48/000000/css3.png" alt="" /> CSS</h2>
          </div>
        </div>
      </div> */}


<section id="skills" class="py-10 bg-gray-100">
  <div class="container mx-auto px-5">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      <div class="bg-white p-5 shadow-lg rounded-lg text-center">
        ...
        <p class="text-gray-600 mt-2">HTML, CSS, JavaScript, React, Redux</p>
      </div>
      <div class="bg-white p-5 shadow-lg rounded-lg text-center">
        <h3 class="text-xl font-semibold">Backend Development</h3>
        <p class="text-gray-600 mt-2">Node.js, Express.js, MongoDB</p>
      </div>
      <div class="bg-white p-5 shadow-lg rounded-lg text-center">
        <h3 class="text-xl font-semibold">Tools & Technologies</h3>
        <p class="text-gray-600 mt-2">Git, Webpack, Babel, Firebase</p>
      </div>
      <div class="bg-white p-5 shadow-lg rounded-lg text-center">
        <h3 class="text-xl font-semibold">Design</h3>
        <p class="text-gray-600 mt-2">Adobe Photoshop, Figma</p>
      </div>
      <div class="bg-white p-5 shadow-lg rounded-lg text-center">
        <h3 class="text-xl font-semibold">Others</h3>
        <p class="text-gray-600 mt-2">API Integration, UI/UX Design</p>
      </div>
    </div>
  </div>
</section>
