...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className="project" style={{ backgrou F7F7F7}}>
          ...
          <div className="project1">
            <center>
              ...
              <div className="buttonAll">
                <a href="/allproject"><button className='buttonPr' style={{border:'1px solid black'}}>Посмотреть все<br />проекты</button><br /><br /></a>
              </div>
            </center>
          </div>
        </div>
