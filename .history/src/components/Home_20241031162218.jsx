...
Упоминание о вашей школе в портфолио может быть не банальным, если вы подчеркнете, что именно она повлияла на ваш выбор карьеры или развила ваши навыки. Например, вы можете рассказать о специализированных курсах, проектах или активностях, которые вы там проходили. Это может добавить индивидуальности вашему портфолио и показать, как ваш путь к настоящему моменту был сформирован.

Вот пример того, как это можно вписать:
