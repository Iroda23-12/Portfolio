    ...
    <>
      ...
      <div className="about" style={{ textAlign: 'center', padding: '40px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', textAlign: 'center', width: '100%' }}>
          <p style={{ width: '600px' }}>
            <h2>О себе</h2><br />
            Привет! Меня зовут , и я - страстный разработчик, специализирующийся на веб-технологиях. Моя любовь к программированию началась в школе, где я активно участвовал в [упомяните о каких-либо курсах, проектах или кружках]. Эти опыты стали основой моего пути в IT.
