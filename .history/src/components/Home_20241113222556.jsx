...
import { faArrowAltCircleDown, faBurger, faCommentDots, faEnvelope, faHeadset, faLaptopCode, faMapMarkedAlt, faPaperPlane, faPhone, faPhoneAlt, faUser, } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      <header className='navbar_gl'>  
        ...
        <nav className="navbar">
          <label htmlFor="nav"><FontAwesomeIcon icon={faBurger}/></label>
          <input type="chexbox" name="" id="" />
          <ul>
