    ...
    <>
      <div className="home" style={{ backgroundColor: '#F7F7F7' }}>
        ...
        <div className="avatar">
          <img src="girl1.png" alt="Avatar" className="avatar-image" />import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faInstagram, faTelegram } from '@fortawesome/free-brands-svg-icons';
import { faArrowAltCircleDown, faUser } from '@fortawesome/free-solid-svg-icons';
import React from 'react';
  ...
  return (
    <>
      ...
      <div className="about" style={{ 
        textAlign: 'center', 
        padding: '220px', 
        backgroundImage: 'url(data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD/2wCEAAkGBw8PDw0PDw0NDw8NDQ0NDw8NDQ8NDQ0NFREWFhURFRUYHSggGBolGxUVITEhJSktLi4vFx8zODMsNygtLisBCgoKDg0NDw8PFSsZFRkrKy0rKy0rKy0rKzcrKysrKzc3LSsrKystNy0rKysrKysrKys3KysrKysrKysrKysrK), no-repeat', 
