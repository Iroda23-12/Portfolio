      ...
      <div className="project">
        <div className="project1">
          ...
          <div className="project-description">
            <h2>Uzbekistan Explorer.com</h2>
            <p>This website is aimed at promoting tourism in Uzbekistan. It includes interactive maps, searchable databases, and a blog section. I used React and Zustand for state management, and Netlify for hosting. </p>
