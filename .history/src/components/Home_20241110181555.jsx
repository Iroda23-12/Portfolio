...
import { faArrowAltCircleDown, faCommentDots, faEnvelope, faHeadset, faLaptopCode, faPaperPlane, faPhone, faPhoneAlt, faUser, } from '@fortawesome/free-solid-svg-icons';
