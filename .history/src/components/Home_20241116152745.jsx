...
import { faArrowAltCircleDown, faBars, faBurger, faCommentDots, faEnvelope, faHamburger, faHeadset, faLaptopCode, faMapMarkedAlt, faPaperPlane, faPhone, faPhoneAlt, faUser, faX, } from '@fortawesome/free-solid-svg-icons';
...
const Home = () => {
  ...
  return (
    <>
      <header className='navbar_gl'>
        <a href="/" className="logo"><i className="fab fa-node-js"></i><img src="logo.png" style={{ width: '70px', marginTop: '10px' }} alt="" /></a>
      ...
      <div className="bg-[#1A1A2E] text-white py-10" style={{ backgroundColor: '#1A1A2E' }}>
        <div className="container mx-auto flex flex-wrap justify-between space-y-6 md:space-y-0">
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            <p className="text-lg mb-4">{t("Thanks")}</p>
            <p className="text-xl font-semibold">{t("Keep Rising")}</p>
          </div>
          ...
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            ...
            <ul className="space-y-4">
              <li>
                <FontAwesomeIcon icon={faPhoneAlt} color="orange" /> +998 (XX)-XXX-XX-XX
              </li>
              <li>
                <FontAwesomeIcon icon={faEnvelope} color="orange" /> iroda6638@gmail.com
              </li>
              <li>
                <FontAwesomeIcon icon={faMapMarkedAlt} color="orange" /> {t("Uzbekistan Tashkent")}
              </li>
            </ul>
            <div className="mt-4 flex space-x-6">
              <a
                href="https://www.instagram.com/bxbyy._.i/"
                className="text-white hover:text-[#0077b5] flex items-center justify-center"
                style={{
              ...
              <a
                href="#"
                className="text-white hover:text-[#333] flex items-center justify-center"
                style={{
                  backgroundColor: 'white',
                  color: '#333',
                  padding: '.5rem',
              ...
              <a
                href="#"
                className="text-white hover:text-[#1DA1F2] flex items-center justify-center"
                style={{
                  backgroundColor: 'white',
                  color: '#333',
                  padding: '.5rem',
              ...
              <a
                href="https://t.me/+998336104445"
                className="text-white hover:text-[#0088cc] flex items-center justify-center"
                style={{
                  backgroundColor: 'white',
                  color: '#333',
                  padding: '.5rem',
        ...
        >
          <p>{t("Designed With ❤️ By Iroda")}</p>
        </div>
      </div>
    </>
  );
