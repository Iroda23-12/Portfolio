  ...
  return (
    <>
      ...
      <div className="about" style={{
        ...
        padding: '220px',
        height: '100vh',
        backgroundImage: 'url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTADFCC-GrqriiMjCeRjIACkBG1ceH6L_vlanbGibT0mJmV3gbW1iK9Qe98yc2t9JHD2Rg&usqp=CAU)',
