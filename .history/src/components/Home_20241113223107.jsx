...
import { faArrowAltCircleDown, faBurger, faCommentDots, faEnvelope, faHamburger, faHeadset, faLaptopCode, faMapMarkedAlt, faPaperPlane, faPhone, faPhoneAlt, faUser, } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      <header className='navbar_gl'>  
        ...
        <nav className="navbar">
          <label htmlFor="nav"><FontAwesomeIcon icon={faHamburger}/></label>
