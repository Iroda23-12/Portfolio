...
import { faBootstrap, faGithub, faHtml5, faInstagram, faJava, faJs, faReact, faTelegram } from '@fortawesome/free-brands-svg-icons';
  ...
  return (
    <>
      ...
      <div className="skills">
        ...
        <h2> <img src="https://img.icons8.com/color/48/000000/bootstrap.png" width={'21px'}  alt="" /> ReactJs</h2>
        <h2><FontAwesomeIcon icon={faHtml5} color='#F56200' />ReactJs</h2>
        <h2><FontAwesomeIcon icon={facss} color='#F56200' />ReactJs</h2>
      </div>
    </>
  );
};
