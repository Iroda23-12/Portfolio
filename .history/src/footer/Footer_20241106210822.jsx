...
import { faCreativeCommonsSamplingPlus, faGithub, faInstagram, faLinkedin, faTelegram, faTwitter } from '@fortawesome/free-brands-svg-icons';
import { faHeadphones, faMailBulk, faPhone, faPhoneAlt } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      <div className="footer">
        <div className="footer-container">
          ...
          <h5><FontAwesomeIcon icon={faCreativeCommonsSamplingPlus}/></h5>
        </div>
      </div>
    </>
  );
