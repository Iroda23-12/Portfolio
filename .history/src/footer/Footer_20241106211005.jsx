...
import { faEnvelope, faHeadphones, faLocation, faMailBulk, faMap, faPhone, faPhoneAlt } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      <div className="footer">
        <div className="footer-container">
          ...
          <h5><FontAwesomeIcon icon={faLocation}/></h5>
        </div>
      </div>
    </>
  );
