...
import { faEnvelope, faHeadphones, faLocation, faMailBulk, faMap, faMapMarked, faPhone, faPhoneAlt } from '@fortawesome/free-solid-svg-icons';
    ...
    <>
      <div className="footer">
        <div className="footer-container">
          ...
          <h5><FontAwesomeIcon icon={faMapMar}/></h5>
        </div>
      </div>
    </>
  );
