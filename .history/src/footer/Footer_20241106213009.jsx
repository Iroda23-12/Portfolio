      ...
      <div className="container mx-auto flex flex-wrap justify-between space-y-6 md:space-y-0">
        ...
        <div className="w-full md:w-1/3">
          ...
          <div className="mt-4 flex space-x-6" >
            <a href="https://www.instagram.com/bxbyy._.i/" className="text-white hover:text-[#0077b5]" style={{backgroundColor:'white',color:'#333',padding:'',borderRadius:'100%'}}>
              <FontAwesomeIcon icon={faInstagram} />
            </a>
            <a href="#" className="text-white hover:text-[#333]" style={{backgroundColor:'white',color:'#333',padding:'',borderRadius:'100%'}}>
              <FontAwesomeIcon icon={faGithub} />
            </a>
            <a href="#" className="text-white hover:text-[#1DA1F2]" style={{backgroundColor:'white',color:'#333',padding:'',borderRadius:'100%'}} >
