      ...
      <div className="container mx-auto flex flex-wrap justify-between space-y-6 md:space-y-0">
        ...
        <div className="w-full md:w-1/3">
          ...
          <ul className="space-y-4">
            <li><FontAwesomeIcon icon={faPhoneAlt} color='orange'/> +998 (XX)-XXX-XX-XX</li>
            <li><FontAwesomeIcon icon={faEnvelope} color='orange'/> iroda6638@gmail.com</li>
            <li><FontAwesomeIcon icon={faMapMarkedAlt}color='orange' /> Uzbekistan Tashkent</li>
          </ul>
